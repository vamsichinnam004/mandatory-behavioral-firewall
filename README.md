...
├── .cursor/
│   └── rules/
│       ├── isolation_rules/    # Специализированные правила от vanzan01
│       │   ├── main.mdc
│       │   ├── Level1/
│       │   ├── Level2/
│       │   ├── Level3/
...
- **Isolation Rules от vanzan01** - продвинутая система изоляционного подхода
- **Стандартных агентов Cursor** для базового контроля качества
- **Любых AI-агентов** работающих с кодом в Cursor IDE

#### 🎯 **Интеграция с Isolation Rules**
При использовании с `isolation_rules/` от vanzan01:
...
- **Isolation Rules (vanzan01)** - синергия с многоуровневой системой изоляционного подхода
